...
| Presidential approval 1993–present | Gallup via UCSB American Presidency Project (`presidency.ucsb.edu/statistics/data/<president>-public-approval`) | `fetch_approval.py` → `data/approval_monthly.csv` | replaces the hand-typed table. UCSB lacks a Trump-2nd-term page as of 2026-07; script auto-tries those slugs on re-run. |
